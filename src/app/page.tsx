...
const samples = [
  {
    slug: "pareto-2025-09",
    href: "/pareto-2025-09",
    title: "Pareto Conference — Sept 2025",
    desc: "Deck, inline charts, video, downloadable PDF.",
  },
  {
    slug: "multimedia-2026-02",
    href: "/presentations/multimedia-2026-02",
    title: "Multimedia Conference — Feb 2026",
    desc: "Charts, video, downloadable pack.",
  },
];
  ...
  return (
    <Container>
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {samples.map((p) => (
          <Link key={p.slug} href={p.href} className="no-underline">
